...
<<<<<<< Updated upstream
\section{Hypothesis}
{\Large If there is an increase in the distance to the object in question, then there shall be an increase in its recessional velocity, because the Hubble-Lemaître law states, mathematically:
=======
{\Large \section{Hypothesis}
...
\tikzstyle{io} = [trapezium, trapezium left angle=70, trapezium right angle=110, minimum width=3cm, minimum height=1cm, text centered, text width=10cm, draw=black]
...
\node (in1) [io, below of=start, yshift=-3cm] {Allows for interplanetary transportation.};

\node (pro1) [process, below of=in1, yshift=-3cm] {Lack of resources.};

\node (dec1) [decision, below of=pro1, yshift=-3cm] {Ruled out.};
...
\node (in1) [io, below of=start, yshift=-3cm] {Stopping the expansion of the universe.};

\node (pro1) [process, below of=in1, yshift=-3cm] {Too expensive.};
...
\node (in1) [io, below of=start, yshift=-3cm] {Creative manipulation of videos.};

\node (pro1) [process, below of=in1, yshift=-3cm] {Too boring.};
...
\node (in1) [io, below of=start, yshift=-3cm] {Computer program that alters redshifted and blueshifted astronomical images.};

\node (pro1) [process, below of=in1, yshift=-3cm] {Feasible.};

\node (dec1) [decision, below of=pro1, yshift=-3cm] {Selected.};
\draw [arrow] (start) -- (in1);
\draw [arrow] (in1) -- (pro1);
\draw [arrow] (pro1) -- (dec1);
\end{tikzpicture}
