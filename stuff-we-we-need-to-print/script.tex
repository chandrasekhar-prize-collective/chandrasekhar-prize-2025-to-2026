...
\subsection{Telescopy: Jain}
[DAKSH YAP ABOUT TELESCOPES AND HOW KEPLER IS BETTER]
\section{Demo: Bodapati}
[Demo here]
\section{Conclusion}
And that is our presentation. Thank you for existing, and we shall conclude with a final farewell:

Farewell, Eukarya Animalia Bilateria Deuterostomia Chordata Vertebrata Gnathostomata Tetrapoda Mammalia Theria Eutheria Primates Haphlorrhini Simiiformes Hominoidea Hominidae Homininae Hominini \textit{Homo sapiens}.
