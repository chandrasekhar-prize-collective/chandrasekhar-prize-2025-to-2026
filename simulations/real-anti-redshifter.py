import cv2
import numpy as np
inputImg = input("Enter the name of the image you want to process (make sure it's in the same directory as this script, e.g., img.png): ")
img = cv2.imread(inputImg).astype(np.float32)
